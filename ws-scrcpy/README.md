...
* **Android 14+ Clipboard Error**: On Android 14 and newer, you may see a
  `NoSuchMethodException` error related to clipboard functionality. This is a
  known issue with scrcpy and is non-fatal - the server should continue to work
  despite this error. If you experience a black screen, try:
  - Restarting the device
  - Using a different video player (try switching players in the configuration dialog)
  - Ensuring the stream is properly configured with valid video settings
